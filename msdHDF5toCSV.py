    ...
    if prompt == True:
        while prompt:
            ...
            csvAttributeString = raw_input("\n\nIn what order would you like the colums of the CSV file?\n" +
                ...
                "ArtistName, Danceability, Duration, Energy, KeySignature, KeySignatureConfidence, Tempo," +
                "SongID, SongHotttnesss, TimeSignature, TimeSignatureConfidence, Title, and Year.\n\n" +
